...
P.S. Проектные сайты и сам бот [@AirQuality174Bot](https://t.me/AirQuality174Bot) работают только тогда, когда запущена кластерная машина, не всегда могу держать её включенной, поэтому лучше в личку стучитесь)
